...
class SapiTestingExports implements FromCollection, WithHeadings, WithMapping
{
    ...
    {
        return SapiTesting::select('id', 'jenis_sapi', 'umur', 'berat', 'jenis_kelamin',  'kondisi_mulut_datar', 'kepala', 'leher_bergelambir', 'punggung_datar', 'ekor_tidak_ada_legokan', 'kaki_tegak_besar', 'kondisi_gigi_lengkap', 'kondisi_mata_normal')->get();
    }
}